...
# Prova de Conceito: É possível utilizar os incrivel 1TB (1024 gigabytes) de armazenamento de imagens 
# do Flickr pra hospedar arquivos através concatenando imagens?
...
def get_from_set(set_id)
	# uso API com key do usuário (poderia ser qualquer uma válida)
	require 'flickraw' # 3
...
# sobe tudo como imagens pro flickr
set_id = upload_to_flickr
# download e remonta a pasta
get_from_set set_id
